  ...
  async function genera() {
    ...
    try {
      ...
      const cfgObj = {
        ...
        sup_mattina_feriale:    config?.sup_mattina_feriale    ?? 0,
        sup_mattina_festivo:    config?.sup_mattina_festivo    ?? 0,
        sup_pomeriggio_feriale: config?.sup_pomeriggio_feriale ?? 0,
        sup_pomeriggio_festivo: config?.sup_pomeriggio_festivo ?? 0,
        sub_mattina_sabato:    config?.sub_mattina_sabato    ?? 0,
        sub_pomeriggio_sabato: config?.sub_pomeriggio_sabato ?? 0,
        med_mattina_sabato:    config?.med_mattina_sabato    ?? 0,
        med_pomeriggio_sabato: config?.med_pomeriggio_sabato ?? 0,
        sup_mattina_sabato:    config?.sup_mattina_sabato    ?? 0,
        sup_pomeriggio_sabato: config?.sup_pomeriggio_sabato ?? 0,
